...
import org.neyamul.securitydemo.jwt.AuthEntryPointJwt;
import org.neyamul.securitydemo.jwt.AuthTokenFilter;
    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests((
                ...
                authorizeRequests.requestMatchers("/h2-console/**")
                        .permitAll().
                        requestMatchers("/api/greetings/signing").permitAll().
